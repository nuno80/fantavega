...
<body class="is-loading">
  ...
  (() => {
    ...
    function tableColumns(){
      return [{type:"meta",index:FIELD.name,label:"Giocatore",fullLabel:"Nome"},{type:"offer",index:"offer",label:"Offerta %",fullLabel:data.columns[currentOfferIndex()].label},...[...state.selectedColumns].filter((index)=>index!==FIELD.name).map((index)=>({type:"meta",index,label:data.columns[index].shortLabel,fullLabel:data.columns[index].label}))];
    }
