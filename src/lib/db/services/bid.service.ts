...
import type { ExpiredAuctionData } from "./bid-expiry";
...
// Re-export: logica chiusura aste scadute estratta in bid-expiry.ts
export { processExpiredAuctionsAndAssignPlayers, closeAllActiveAuctionsForLeague };
export type { ExpiredAuctionData };
...
export const getAuctionStatusForPlayer = async (
  ...
  console.log(
    `[getAuctionStatusForPlayer] ðŸ” CRITICAL DEBUG - Searching for auction: league=${leagueIdParam}, player=${playerIdParam}, currentTime=${currentTime}`
  );
  ...
  if (activeAuctionData) {
    console.log(`[getAuctionStatusForPlayer] âœ… Found ACTIVE auction:`, {
